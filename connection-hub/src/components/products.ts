    ...
    accounts: [
      {
        ...
        intents: defaultIntents('chase2-checking'),
      },
      {
        id: 'chase2-freedom',
        ...
        intents: defaultIntents('chase2-freedom'),
      },
    ],
  },
  {
    ...
    accounts: [
      {
        ...
        intents: defaultIntents('chase3-private'),
      },
      {
        id: 'chase3-mortgage',
        name: 'Home Mortgage',
        ...
        intents: defaultIntents('chase3-mortgage'),
      },
      {
        id: 'chase3-auto',
        name: 'Auto Loan',
        ...
        intents: defaultIntents('chase3-auto'),
      },
    ],
  },
  {
